...
\input{\MemModel/Stretching}
\input{\MemModel/Bending}

\section{
انرژی آزاد یک شبکه‌ی مثلثی
}
\input{\MemModel/StretchingTriMesh}
\input{\MemModel/BendingTriMesh}
\section{
تغییر انرژی آزاد با افزودن نقطه‌ی نقص به شبکه
}
\input{\MemModel/StretchingTriDisc}
\input{\MemModel/BendingTriDisc}
\input{\MemModel/GammaTriDisc}
